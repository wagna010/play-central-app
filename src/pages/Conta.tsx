...
const Conta = () => {
  ...
  const inputs = [
    codeRef, searchButtonRef,
    urlRef, portRef, usernameRef, passwordRef,
    saveButtonRef, clearButtonRef, backButtonRef
  ];
  ...
  const handleSaveManual = async () => {
    ...
    const config = { url, port, username, password };
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    if (e.key === 'ArrowDown') {
      ...
      else if (focusIndex === 8) navigate('/home');
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-no-repeat flex flex-col items-center justify-start"
      ...
      <button
        ...
        className="absolute top-8 left-8 bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-all focus:outline-white focus:outline-[3px]"
      >
        ← Voltar
      </button>
      ...
      <div className="bg-black/65 p-10 rounded-[20px] w-[550px] mt-[80px] flex flex-col items-center">
        ...
        <div className="w-full flex gap-3 mb-4">
          <input
            ...
            className="flex-1 p-3 border-0 rounded-lg text-base outline-none focus:outline-[#00adee] focus:outline-2"
          />
          <input
            ref={portRef}
            type="text"
            ...
            placeholder="Porta"
            className="w-[100px] p-3 border-0 rounded-lg text-base outline-none focus:outline-[#00adee] focus:outline-2"
          />
        </div>
        ...
        <input
          ...
          placeholder="Usuário"
          className="w-full p-3 mb-4 border-0 rounded-lg text-base outline-none focus:outline-[#00adee] focus:outline-2"
        />
        ...
        <button
          ...
          className="w-full py-[14px] text-lg border-0 rounded-lg bg-[#00adee] text-white cursor-pointer transition-all hover:bg-[#0095cc] mb-3 focus:outline-white focus:outline-[3px]"
        >
          💾 Salvar Configuração
        </button>
        ...
        <button
          ...
          className="w-full py-[14px] text-lg border-0 rounded-lg bg-red-600 text-white cursor-pointer transition-all hover:bg-red-700 focus:outline-white focus:outline-[3px]"
        >
          🔄 Voltar ao Modo Demo
        </button>
        
        {message && (
          <div className="mt-4 text-center text-sm bg-white/10 px-4 py-2 rounded-lg">
